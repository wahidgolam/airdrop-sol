...
public class Order {
    ...
    public Order(String outletID, String studentID, Timestamp placedTime, int statusCode, String itemID, int quantity, long totalAmount,long discountedAmount, String itemName, String itemImage) {
        this.outletID = outletID;
        this.studentID = studentID;
        this.placedTime = placedTime;
        this.statusCode = statusCode;
    ...
    public void setPaymentOrderID(String paymentID) {
        this.paymentOrderID = paymentID;
    }
    ...
    public long sortPlacedTime(){
        return placedTime.getSeconds();
    }
