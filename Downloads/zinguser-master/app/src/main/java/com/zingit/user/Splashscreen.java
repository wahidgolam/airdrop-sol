        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if(user!=null){
                    ...
                    userConcerned.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                            if (task.isSuccessful()) {
                                ...
                                if (document.exists()) {
                                    //set Data-holder
                                    Dataholder.studentUser = document.toObject(StudentUser.class);
                                    Dataholder.cart = new Cart();
                                    if (Dataholder.studentUser.getCampusID().equals("undef")){
                    ...
                    Dataholder.firstTimeLogin = true;
                    goToLogin();
                }
            }
        }, 100);
